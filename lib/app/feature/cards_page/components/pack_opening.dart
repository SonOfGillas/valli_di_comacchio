...
const cardsInThePack = [
  'assets/images/eel_card.png',
  'assets/images/flamingo_card.png',
  'assets/images/duck_card.png',
  'assets/images/fox_card.png',
  'assets/images/hawk_card.png',
];
...
class _PackOpeningPageState extends State<PackOpeningPage>
  ...
  final List<String> _revealedCards = [];

  // List of cards remaining in the pack
  late List<String> _remainingCards;
